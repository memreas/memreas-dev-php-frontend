                ...
                for (var json_key = 0;json_key < count_media;json_key++){
                    ...
                    if (_media_type == 'video'){
                        ...
                        $.post('/index/buildvideocache', {video_url:_media_url, thumbnail:mediaThumbnail, media_id:mediaId}, function(response_data){
                            ...
                            $(".edit-area-scroll .first-element").append ('<li class="video-media"><a class="image-sync" id="' + response_data.media_id + '" onclick="return imageChoosed(this.id);" href="' + response_data.thumbnail + '"><img src="' + response_data.thumbnail + '"/><img class="overlay-videoimg" src="/memreas/img/video-overlay.png" /></a></li>');
                        });
                    }
                    else {
