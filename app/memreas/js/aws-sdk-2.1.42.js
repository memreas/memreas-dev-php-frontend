_xamzrequire = function e(t, n, r) {
                ...
                if (querystring) {
                    ...
                    if (resources.length) {
                        ...
                        AWS.util.arrayEach(resources, function(res) {
                            if (res.value === undefined) querystring.push(res.name); else querystring.push(res.name + "=" + res.value);
                        });
    ...
    25: [ function(require, module, exports) {
        ...
        AWS.CognitoIdentityCredentials = AWS.util.inherit(AWS.Credentials, {
            ...
            storage: function() {
                try {
                    return AWS.util.isBrowser() && typeof window.localStorage === "object" ? window.localStorage : {};
                } catch (_) {
                    return {};
                }
            }()
