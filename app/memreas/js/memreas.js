		    ...
		    ajaxRequest(
				...
				if (getValueFromXMLTag(response, 'status') == "Success") {
					...
					for (var i = 0; i < friend_count; i++) {
					    ...
					    // $(friend).filter('event_friends')
					    // .html();
					    // var event_resources =
					    // $(events_resources).filter(
					    // 'event_friend');
					    // var event_resources_count =
					    // event_resources.length;
					    // var total_event_row_width = 120 *
					    // event_resources_count;
					    //
					    ...
					    // if (event_resources_count > 0) {
					    // for (var key = 0; key <
					    // event_resources_count; key++) {
					    // var event_resource =
					    // event_resources[key].innerHTML;
					    // console.log('event_resource-->'
					    // + event_resource);
					    // var event_friend_id =
					    // $(event_resource).filter(
					    // 'event_friend_id').html();
					    // var event_friend_social_username
					    // = $(event_resource).filter(
					    // 'event_friend_social_username').html();
					    // var event_friend_url_image =
					    // $(event_resource).filter(
					    ...
					    // event_metadata = JSON
					    // .parse(event_metadata);
					    // if (typeof (event_metadata.price)
					    // != 'undefined') {
					    // if (event_metadata.price != '')
					    // sell_price =
					    // event_metadata.price;
					    // }
					    // }
					    // if (sell_price == '') {
					    ...
					    // $("#" + friend_row)
					    // .append(
					    // '<div class="event_img"><a
					    // href="javascript:showEventDetail(\''
					    // + eventId
					    // + '\', \''
					    // + user_id
					    // + '\');">'
					    ...
					    // + event_name
					    // + '\');"><div
					    // class="sell-event-overlay"></div><span
					    // class="sell-event-buyme"><i>checking...</i></span><img
					    // src="'
					    // + event_friend_url_image
					    // + '" alt=""><span
					    // class="event_name_box"><a
					    ...
					    // + '</a></span></div>');
					    //
					    // // Start requesting to pay server
					    // for
					    // // checking event is bought or
					    // not
					    // var params = new Object;
