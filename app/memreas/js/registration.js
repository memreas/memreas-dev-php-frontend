...
$('#reportVolForm').click(
	function() {
	    ...
	    console.log('Media ID-->' + mediaId_report + "Owner-->"
		    + copy_right_owner + 'address-->' + copyright_owner_address
		    + "Email-->" + copyright_owner_email_address
