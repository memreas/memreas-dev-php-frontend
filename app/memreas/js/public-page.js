...
$(function() {
   $('.event-pics-p').append('<li class="image"><a href="javascript:;"  style="cursor: pointer;"><img src="/memreas/img/Beach.png" style=""></a></li>'+
                                        '<li class="image"><a href="javascript:;"  style="cursor: pointer;"><img src="/memreas/img/FallSeason1.png" style=""></a></li>'+
                                        '<li class="image"><a href="javascript:;"  style="cursor: pointer;"><img src="/memreas/img/FallSeason2.png" style=""></a></li>') 
});
