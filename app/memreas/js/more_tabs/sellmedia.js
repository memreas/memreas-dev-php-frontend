...
function checkSellerBasicInformation(element, focus_element) {
	...
	if (age < 18) {
	    jerror("you must be at least 18 years of age");
	    formPass = false;
	    return formPass;
	}
    } else {
...
function resetSellMedia() {
    var text_ids = [ 'sell-media-fname', 'sell-media-lname',
	    ...
	    'sell-media-state', 'sell-media-zip', 'sell-media-tax_ssn_ein',
	    'sell-media-bank', 'sell-media-bank-routing',
	    'sell-media-account-number' ];
